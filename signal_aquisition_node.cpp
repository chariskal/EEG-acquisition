/*******************************************
 ** Mavridis and Kalavrytinos @ CSL, NTUA **
 *******************************************
Description: First draft of Node file for ROS for EEG Acquisition. For a more updated file, check ./grasping/grasping.cpp and grasping_ros.cpp
